...
BEGIN
  ...
  SELECT special_characters."first_name",
         special_characters."middle_name",
         special_characters."last_name",
         special_characters."surname",
         special_characters."email",
         special_characters."picture_url",
   ...
   WHERE special_characters."user_uuid" = p_user_uuid;
